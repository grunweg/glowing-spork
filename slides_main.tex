...
\includegraphics[width=3.2cm]{images/logo_bms.png}\hspace{2mm} % TODO add proper logo!
\includegraphics[width=2.8cm]{images/logo_math+.png}\hspace{2mm}
\includegraphics[width=1.2cm]{images/logo_hu.png}\hspace{2mm}
\raisebox{-3mm}{\makebox{\includegraphics[width=1.5cm]{images/logo_erc.jpg}}}
}
...
\input{intro}
\input{motivation}
\input{sample_questions}
\input{holomorphic_curves}
\input{conclusion}
\end{document}

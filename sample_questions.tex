...
% I'm cheating a little bit here; the actual statement is a bit more complicated. Given a non-deg Hamiltonian diffeo, there are infinitely many simple periodic points -- i.e., \exists some Hamiltonian with same time-1 map.
  \begin{block}{\shrink{(Almost the) }Conley conjecture}
